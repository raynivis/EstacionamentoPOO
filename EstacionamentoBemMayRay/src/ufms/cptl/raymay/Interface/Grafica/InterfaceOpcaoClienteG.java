 ...
 * @author maymi
 */
public class InterfaceOpcaoClienteG {
    OperacoesCliente opCliente = new OperacoesCliente();
    
    ItensMenuG menuc = new ItensMenuG(); /* menuc = Menu de gerencia de Clientes */
    ItensMenuG menuve = new ItensMenuG(); /*menuve = Menu de gerencia de Veículos */
    
    AuxiliarInterfaceCadastraVeiculoG InVeiculo = new AuxiliarInterfaceCadastraVeiculoG();
