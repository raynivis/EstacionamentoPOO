...
public class InterfaceInicial{
    ...
    public void realizarPrimeirasOpcoes(List<Cliente> clientes, List<Vaga> vagas, List<Ticket> tickets, List<Tarifa> tarifas, UserInterface inter) {  
        do {
...
=======
                     realizarOpcoesCadastrosGerais(clientes, vagas, tickets, tarifas, inter);                                                                 
>>>>>>> Stashed changes
                break;        
                case 5:                    
...
=======
    ...
    /* Método criado para diminuir o método realizarPrimeiraOpcoes */
    private void realizarOpcoesCadastrosGerais(List<Cliente> clientes, List<Vaga> vagas, List<Ticket> tickets, List<Tarifa> tarifas, UserInterface inter){
        do {                      
            opTicket.verificarMensalista30dias(tickets);
